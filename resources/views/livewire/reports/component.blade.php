                            ...
                            <table class="table table-striped">
                                <thead class="text-white" style="background: #3B3F5C">
                                    <tr>
                                        ...
                                        <th class="table-th text-white text-center">ARTICULOS</th>
                                        <th class="table-th text-white text-center">STATUS</th>
                                        <th class="table-th text-white text-center">CAJERO/A</th>
                                        <th class="table-th text-white text-center">FECHA/VENTA</th>
