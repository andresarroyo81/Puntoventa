...
<div class="row">
    ...
    <div class="col-sm-12 col-md-8">
        <div class="form-group">
            <label>Nombre</label>
            <input type="text" wire:model.lazy="name" class="form-control" placeholder="ej: Leche Lala Fresca Entera Cartón 500ml">
    ...
    <div class="col-sm-12 col-md-4">
        <div class="form-group">
            ...
            <input type="text" wire:model.lazy="barcode" class="form-control" placeholder="ej: 3159346">
