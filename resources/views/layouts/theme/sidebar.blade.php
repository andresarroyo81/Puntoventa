<div class="sidebar-wrapper sidebar-theme">
    <nav id="compactSidebar">
        ...
        <ul class="menu-categories">
            ...
            @can('Ventas_Index')
            <li class="">
                <a href="{{ url('pos') }}" class="menu-toggle" data-active="flase">
                    <div class="base-menu">
                        <div class="base-icons">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            @can('Roles_Index')
                <li class="">
                    <a href="{{ url('roles') }}" class="menu-toggle" data-active="flase">
                        <div class="base-menu">
                            <div class="base-icons">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            @can('Permisos_Index')
                <li class="">
                    <a href="{{ url('permisos') }}" class="menu-toggle" data-active="flase">
                        <div class="base-menu">
                            <div class="base-icons">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
